...
def get_user_preferences():
    ...
    available_actives = df_constants.ACTIVES
...
def run_backtest():
    ...
    with Progress(
        ...
        task2 = progress.add_task("[magenta]Calculating Strategy Bands & Indicators...", total=100)
        signals = SignalLogic(binance_df.df, STRATEGY=prefs["strategy"])
